...
import { AiModerationGeminiProcessorService } from './processors/AiModerationGeminiProcessorService.js';
...
export class QueueProcessorService implements OnApplicationShutdown {
	...
	constructor(
		...
		private aiModerationGeminiProcessorService: AiModerationGeminiProcessorService,
	) {
		...
		//#region system
		{
			const processer = (job: Bull.Job) => {
				switch (job.name) {
					...
					case 'aiModerationGemini': return this.aiModerationGeminiProcessorService.process();
